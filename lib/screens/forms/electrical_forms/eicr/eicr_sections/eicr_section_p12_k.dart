...
class EICRSectionKPart1 extends StatelessWidget {
  const EICRSectionKPart1({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[0][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[0][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[0][keyData][index]
                              [formKey],
                          value,
                        );
                      },
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[1][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[1][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                            formList.listRenderWidgets[1][keyData][index]
                                [formKey],
                            value);
                      },
                      titleSize: fontBody,
...
class EICRSectionKPart2 extends StatelessWidget {
  const EICRSectionKPart2({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[2][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[2][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[2][keyData][index]
                              [formKey],
                          value,
                        );
                      },
...
class EICRSectionKPart3 extends StatelessWidget {
  const EICRSectionKPart3({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[3][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[3][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[3][keyData][index]
                              [formKey],
                          value,
                        );
                      },
...
class EICRSectionKPart4 extends StatelessWidget {
  const EICRSectionKPart4({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[4][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[4][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[4][keyData][index]
                              [formKey],
                          value,
                        );
                      },
...
class EICRSectionKPart5 extends StatelessWidget {
  const EICRSectionKPart5({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[5][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[5][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[5][keyData][index]
                              [formKey],
                          value,
                        );
                      },
...
class EICRSectionKPart6 extends StatelessWidget {
  const EICRSectionKPart6({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[6][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[6][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[6][keyData][index]
                              [formKey],
                          value,
                        );
                      },
...
class EICRSectionKPart7 extends StatelessWidget {
  const EICRSectionKPart7({super.key});
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (BuildContext ctx, int index) =>
                      ...
                      title: formList.listRenderWidgets[7][keyData][index]
                          [keyTitle],
                      value: controller.gazSafetyData[formList
                          .listRenderWidgets[7][keyData][index][formKey]],
                      onChangeValue: (dynamic value) {
                        controller.onChangeFormDataValue(
                          formList.listRenderWidgets[7][keyData][index]
                              [formKey],
                          value,
                        );
                      },
