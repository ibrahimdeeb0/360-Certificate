...
class ElectricalIsolationController extends GetxController {
  int? formId;
  int? certId;
  int? customerId;
  int? siteId;
  ...
  Map<String, dynamic> formData = <String, dynamic>{
    formKeyPart1: <String, dynamic>{
      ...
      formKeyCaution: '',
      formKeyFuses: 'N/A',
      formKeyIsolationOff: 'N/A',
      formKeyMcbOff: 'N/A',
      formKeyFitted: 'N/A',
      formKeyTagsFitted: 'N/A',
      formKeyTimeIsolation: '',
      formKeyIsolationNote: '',
    },
  ...
  List<Widget> get listFormSections => <Widget>[
        const ElectricalIsolationPage1(),
        const ElectricalIsolationPage2(),
      ];
  ...
  Future<void> onUpdateCertificate() async {
    ...
    ApiRequest(
      ...
      className: 'EicController/onUpdateCertificate',
