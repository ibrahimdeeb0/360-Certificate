...
class LeisureAppliancesController extends GetxController {
  ...
  void onInit() {
    ...
    update();
    applianceData = Get.find<LeisureIndustryController>().applianceData;
  }
  ...
  @override
  void onClose() {
    Get.find<LeisureIndustryController>().applianceData = applianceData;
    consoleLog(Get.find<LeisureIndustryController>().applianceData);
