...
class MaintenanceServiceController extends GetxController {
  int? formId;
  int? certId;
  int? customerId;
  int? siteId;
  ...
  List<Widget> get listFormSections => <Widget>[
        const MaintenanceServicePage1(),
        const MaintenanceServicePage2(),
        const MaintenanceServicePage3(),
        const MaintenanceServicePage4(),
        const MaintenanceServicePage5(),
      ];
