...
class MaintenanceServiceSelectSheet extends StatefulWidget {
  const MaintenanceServiceSelectSheet({
    required this.listTitles,
    required this.keyOfPart,
    required this.keyOfValue,
    required this.controller,
    this.keyOfMaintenanceServiceType,
    super.key,
  });
  ...
  final String? keyOfMaintenanceServiceType;
  final MaintenanceServiceController controller;

  @override
  State<MaintenanceServiceSelectSheet> createState() =>
      _MaintenanceServiceSelectSheetState();
}

class _MaintenanceServiceSelectSheetState extends State<MaintenanceServiceSelectSheet> {
                  ...
                  ...filterValues!
                      .map(
                        (String title) => ListOfStrings(
                          onPress: title == 'Other'
                              ? () => Get.bottomSheet(
                                    MaintenanceServiceSelectSheetOtherBT(
                              ...
                              : () {
                                  ...
                                  if (areListsEqual(widget.listTitles,
                                    ...
                                    widget.controller.formData[widget.keyOfPart]
                                            [widget.keyOfMaintenanceServiceType!] =
...
class MaintenanceServiceSelectSheetOtherBT extends StatelessWidget {
  const MaintenanceServiceSelectSheetOtherBT({
    required this.keyOfPart,
    required this.keyOfValue,
    required this.controller,
    super.key,
